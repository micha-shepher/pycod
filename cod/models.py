...
class Client(models.Model):
    ...
    HDprofile           = models.CharField(max_length=20)
    SDprofile           = models.CharField(max_length=20)
    Logo                = models.ForeignKey('LogoProfile')
    AgeRating           = models.BooleanField()
    dualaudio           = models.BooleanField()
    BumperFront         = models.CharField(max_length=20)
    BumperBack          = models.CharField(max_length=20)
...
class AudioTrack(models.Model):
    ...
    client = models.ForeignKey('Client')
    preferedlang    = models.CharField(max_length=10, choices=lang_choices())
    alternativelang = models.CharField(max_length=10, choices=lang_choices())
    type   = models.CharField(max_length=10, choices=AUDIO_CHOICES)
